...
- введение разработанной системы в эксплуатацию.
...
Выявленной проблемой является отсутствие системы прогнозирования и выявления потенциальных неисправностей,
...
Для выявления паттернов в данных был использован алгоритм кластеризации k-Shape.
